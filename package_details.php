...
$images_query = "SELECT * FROM package_images WHERE package_id = ?";
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-6 mb-3">
                        <a href="images/<?php echo $img['image_path']; ?>" class="gallery-image" onclick="return false;">
                            <img src="images/<?php echo $img['image_path']; ?>" class="img-fluid rounded" alt="<?php echo $package['name']; ?> Image">
                        </a>
                    </div>
                    <?php endforeach; ?>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Package details page loaded');
